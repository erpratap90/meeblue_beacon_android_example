...
package com.meeblue.checkblue.core.webview;
...
public class WebViewInterceptDialog extends AppCompatActivity implements DialogInterface.OnDismissListener {
    ...
    public static final String APP_LINK_HOST = "meeblue.com";
    public static final String APP_LINK_ACTION = "com.meeblue.applink";
